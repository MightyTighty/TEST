                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-title text-center mb-80">
                                    <h2 className="title title-animation">Detect Deepfakes with Unmatched <span> Speed </span>and<span> Precision</span> using Raid AI</h2>
                                </div>
                            </div>
                        </div>
                        <div className="row justify-content-center">
                                ...
                                <div className="writing-item">
                                    <div className="writing-shape">
                                        <svg viewBox="0 0 417 207" fill="none" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" preserveAspectRatio="none">
                                            <g opacity="0.1">
                                                <path fillRule="evenodd" clipRule="evenodd" d="M0 96C0 82 7.5 73 26.2229 76.38C43.8225 79.5573 73.5 62.5 65 34C58.0931 10.8417 68.4854 0.0152226 90.4536 0H387C403.569 0 417 13.4315 417 30V177C417 193.569 403.569 207 387 207H30C13.4315 207 0 193.569 0 177V96Z" fill="currentcolor" />
                                    ...
                                    <div className="writing-content">
                                        <h4 className="title">Advanced Deepfake Audio Detection</h4>
                                        <p>Quickly and accurately identify deepfake audio to protect your brand and privacy.</p>
                                        <Link href="/work" className="link-btn">Try Deepfake Detection<i className="far fa-arrow-right" /></Link>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-9">
                                <div className="writing-item">
                                    ...
                                    <div className="writing-content">
                                        <h4 className="title">Customizable Security Features</h4>
                                        <p>Tailor detection settings to meet your organization's specific needs.</p>
                                        <Link href="/work" className="link-btn">Learn<i className="far fa-arrow-right" /></Link>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-9">
                                <div className="writing-item">
                                    ...
                                    <div className="writing-content">
                                        <h4 className="title">Supports 30+ languages</h4>
                                        <p>Unlike anything you've experienced - unique and unimaginable capabilities.</p>
                                        <Link href="/work" className="link-btn">View Language Support<i className="far fa-arrow-right" /></Link>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-9">
                                <div className="writing-item">
                                    ...
                                    <div className="writing-content">
                                        <h4 className="title">Built for Scalability</h4>
                                        <p>Whether you're a small business or a large enterprise, our solutions grow with you.</p>
                                        <Link href="/work" className="link-btn">Try streamline<i className="far fa-arrow-right" /></Link>
                                    </div>
                                </div>
                            </div>
